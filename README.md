...
3. 值填入你刚才生成的**密钥字符串**。
### 初始化容器
1. 创建新的桌面空间: [![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?hide_repo_select=true&ref=main&location=southeastasia)
